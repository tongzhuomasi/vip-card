...
export default new Router({
  routes: [
    ...
    // 个人信息及其子页面
    { path: '/home/personalInfo/personalInfo', component: personalInfo }, // 个人信息
    { path: '/home/personalInfo/myInvitationCode', component: myInvitationCode }, // 我的邀请码
    // 我的团队及其子页面
    { path: '/home/myGroup/myGroup', component: myGroup }, // 我的团队
    ...
    // 消费记录及其子页面
    { path: '/home/purchaseRecord/purchaseRecord', component: purchaseRecord }, // 消费记录
    // 我的钱包及其子页面
    { path: '/home/wallet/wallet', component: wallet }, // 我的钱包
